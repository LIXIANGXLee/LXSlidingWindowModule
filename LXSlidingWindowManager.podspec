#
#  Be sure to run `pod spec lint LXSlidingWindowManager.podspec' to ensure this is a
...
spec.swift_version = "5.0"
  ...
  spec.source       = { :git => "https://github.com/LIXIANGXLee/LXSlidingWindowModule.git", :tag => "#{spec.version}" }
  ...
  #
   ...
   spec.source_files = 'LXSlidingWindowManager/*.{swift}'
   spec.resource = "LXSlidingWindowManager/*.bundle"

   spec.dependency "LXFitManager"
   spec.dependency "LXDarkModeManager"
 ...
 # spec.exclude_files = "Classes/Exclude"
  ...
  # spec.dependency "LXFitManager", "~> 1.4"
